...
// $sttという変数名を定義（別にどんな名前でもいい、Statmentの略？）
    $stt = $db->prepare('INSERT INTO talk(name, date, talk) VALUES(:name, :date, :talk)');
    ...
    header('Location: http://'.$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']).'/tweet.php');
...
<body>
<form method="POST" action="tweet3.php">
